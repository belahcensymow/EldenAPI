...
namespace EldenRingDataExtractor
{
	...
	public class ShopLineupParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | equipId: {equipId} | value: {value} | mtrlId: {mtrlId} | eventFlag_forStock: {eventFlag_forStock} | eventFlag_forRelease: {eventFlag_forRelease} | sellQuantity: {sellQuantity} | equipType: {equipType} | costType: {costType} | setNum: {setNum} | value_Add: {value_Add} | value_Magnification: {value_Magnification} | iconId: {iconId} | nameMsgId: {nameMsgId} | menuTitleMsgId: {menuTitleMsgId} | menuIconId: {menuIconId}";
	}
}
