...
namespace EldenRingDataExtractor
{
	...
	public class SwordArtsParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | disableParam_NT: {disableParam_NT} | swordArtsType: {swordArtsType} | artsSpeedType: {artsSpeedType} | refStatus: {refStatus} | isRefRightArts: {isRefRightArts} | isGrayoutLeftHand: {isGrayoutLeftHand} | isGrayoutRightHand: {isGrayoutRightHand} | isGrayoutBothHand: {isGrayoutBothHand} | usePoint_L1: {usePoint_L1} | usePoint_L2: {usePoint_L2} | usePoint_R1: {usePoint_R1} | usePoint_R2: {usePoint_R2} | textId: {textId} | useMagicPoint_L1: {useMagicPoint_L1} | useMagicPoint_L2: {useMagicPoint_L2} | useMagicPoint_R1: {useMagicPoint_R1} | useMagicPoint_R2: {useMagicPoint_R2} | shieldIconType: {shieldIconType} | iconId: {iconId} | aiUsageId: {aiUsageId}";
	}
}
