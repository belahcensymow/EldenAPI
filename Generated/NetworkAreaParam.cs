...
namespace EldenRingDataExtractor
{
	...
	public class NetworkAreaParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | cellSizeX: {cellSizeX} | cellSizeY: {cellSizeY} | cellSizeZ: {cellSizeZ} | cellOffsetX: {cellOffsetX} | cellOffsetY: {cellOffsetY} | cellOffsetZ: {cellOffsetZ}";
	}
}
