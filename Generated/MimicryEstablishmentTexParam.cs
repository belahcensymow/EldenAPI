...
namespace EldenRingDataExtractor
{
	...
	public class MimicryEstablishmentTexParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | disableParam_NT: {disableParam_NT} | srcR: {srcR} | srcG: {srcG} | srcB: {srcB} | mimicryEstablishmentParamId: {mimicryEstablishmentParamId}";
	}
}
