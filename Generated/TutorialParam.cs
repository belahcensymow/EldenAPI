...
namespace EldenRingDataExtractor
{
	...
	public class TutorialParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | imageId: {imageId} | unlockEventFlagId: {unlockEventFlagId} | textId: {textId} | displayMinTime: {displayMinTime} | displayTime: {displayTime}";
	}
}
