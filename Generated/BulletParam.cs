...
namespace EldenRingDataExtractor
{
	...
	public class BulletParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | atkId_Bullet: {atkId_Bullet} | sfxId_Bullet: {sfxId_Bullet} | sfxId_Hit: {sfxId_Hit} | sfxId_Flick: {sfxId_Flick} | life: {life} | dist: {dist} | shootInterval: {shootInterval} | gravityInRange: {gravityInRange} | gravityOutRange: {gravityOutRange} | hormingStopRange: {hormingStopRange} | initVellocity: {initVellocity} | accelInRange: {accelInRange} | accelOutRange: {accelOutRange} | maxVellocity: {maxVellocity} | minVellocity: {minVellocity} | accelTime: {accelTime} | homingBeginDist: {homingBeginDist} | hitRadius: {hitRadius} | hitRadiusMax: {hitRadiusMax} | spreadTime: {spreadTime} | expDelay: {expDelay} | hormingOffsetRange: {hormingOffsetRange} | dmgHitRecordLifeTime: {dmgHitRecordLifeTime} | externalForce: {externalForce} | spEffectIDForShooter: {spEffectIDForShooter} | autoSearchNPCThinkID: {autoSearchNPCThinkID} | HitBulletID: {HitBulletID} | spEffectId0: {spEffectId0} | spEffectId1: {spEffectId1} | spEffectId2: {spEffectId2} | spEffectId3: {spEffectId3} | spEffectId4: {spEffectId4} | numShoot: {numShoot} | homingAngle: {homingAngle} | shootAngle: {shootAngle} | shootAngleInterval: {shootAngleInterval} | shootAngleXInterval: {shootAngleXInterval} | damageDamp: {damageDamp} | spelDamageDamp: {spelDamageDamp} | fireDamageDamp: {fireDamageDamp} | thunderDamageDamp: {thunderDamageDamp} | staminaDamp: {staminaDamp} | knockbackDamp: {knockbackDamp} | shootAngleXZ: {shootAngleXZ} | lockShootLimitAng: {lockShootLimitAng} | prevVelocityDirRate: {prevVelocityDirRate} | atkAttribute: {atkAttribute} | spAttribute: {spAttribute} | Material_AttackType: {Material_AttackType} | Material_AttackMaterial: {Material_AttackMaterial} | isPenetrateChr: {isPenetrateChr} | isPenetrateObj: {isPenetrateObj} | launchConditionType: {launchConditionType} | FollowType: {FollowType} | EmittePosType: {EmittePosType} | isAttackSFX: {isAttackSFX} | isEndlessHit: {isEndlessHit} | isPenetrateMap: {isPenetrateMap} | isHitBothTeam: {isHitBothTeam} | isUseSharedHitList: {isUseSharedHitList} | isUseMultiDmyPolyIfPlace: {isUseMultiDmyPolyIfPlace} | isHitOtherBulletForceEraseA: {isHitOtherBulletForceEraseA} | isHitOtherBulletForceEraseB: {isHitOtherBulletForceEraseB} | isHitForceMagic: {isHitForceMagic} | isIgnoreSfxIfHitWater: {isIgnoreSfxIfHitWater} | isIgnoreMoveStateIfHitWater: {isIgnoreMoveStateIfHitWater} | isHitDarkForceMagic: {isHitDarkForceMagic} | dmgCalcSide: {dmgCalcSide} | isEnableAutoHoming: {isEnableAutoHoming} | isSyncBulletCulcDumypolyPos: {isSyncBulletCulcDumypolyPos} | isOwnerOverrideInitAngle: {isOwnerOverrideInitAngle} | isInheritSfxToChild: {isInheritSfxToChild} | darkDamageDamp: {darkDamageDamp} | bulletSfxDeleteType_byHit: {bulletSfxDeleteType_byHit} | bulletSfxDeleteType_byLifeDead: {bulletSfxDeleteType_byLifeDead} | targetYOffsetRange: {targetYOffsetRange} | shootAngleYMaxRandom: {shootAngleYMaxRandom} | shootAngleXMaxRandom: {shootAngleXMaxRandom} | intervalCreateBulletId: {intervalCreateBulletId} | intervalCreateTimeMin: {intervalCreateTimeMin} | intervalCreateTimeMax: {intervalCreateTimeMax} | predictionShootObserveTime: {predictionShootObserveTime} | intervalCreateWaitTime: {intervalCreateWaitTime} | sfxPostureType: {sfxPostureType} | createLimitGroupId: {createLimitGroupId} | isInheritSpeedToChild: {isInheritSpeedToChild} | isDisableHitSfx_byChrAndObj: {isDisableHitSfx_byChrAndObj} | isCheckWall_byCenterRay: {isCheckWall_byCenterRay} | isHitFlare: {isHitFlare} | isUseBulletWallFilter: {isUseBulletWallFilter} | isNonDependenceMagicForFunnleNum: {isNonDependenceMagicForFunnleNum} | isAiInterruptShootNoDamageBullet: {isAiInterruptShootNoDamageBullet} | randomCreateRadius: {randomCreateRadius} | followOffset_BaseHeight: {followOffset_BaseHeight} | assetNo_Hit: {assetNo_Hit} | lifeRandomRange: {lifeRandomRange} | homingAngleX: {homingAngleX} | ballisticCalcType: {ballisticCalcType} | attachEffectType: {attachEffectType} | seId_Bullet1: {seId_Bullet1} | seId_Bullet2: {seId_Bullet2} | seId_Hit: {seId_Hit} | seId_Flick: {seId_Flick} | howitzerShootAngleXMin: {howitzerShootAngleXMin} | howitzerShootAngleXMax: {howitzerShootAngleXMax} | howitzerInitMinVelocity: {howitzerInitMinVelocity} | howitzerInitMaxVelocity: {howitzerInitMaxVelocity} | sfxId_ForceErase: {sfxId_ForceErase} | bulletSfxDeleteType_byForceErase: {bulletSfxDeleteType_byForceErase} | followDmypoly_forSfxPose: {followDmypoly_forSfxPose} | followOffset_Radius: {followOffset_Radius} | spBulletDistUpRate: {spBulletDistUpRate} | nolockTargetDist: {nolockTargetDist}";
	}
}
