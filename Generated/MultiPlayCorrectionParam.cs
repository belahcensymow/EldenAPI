...
namespace EldenRingDataExtractor
{
	...
	public class MultiPlayCorrectionParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | client1SpEffectId: {client1SpEffectId} | client2SpEffectId: {client2SpEffectId} | client3SpEffectId: {client3SpEffectId}";
	}
}
