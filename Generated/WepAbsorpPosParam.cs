...
namespace EldenRingDataExtractor
{
	...
	public class WepAbsorpPosParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | right_0: {right_0} | left_0: {left_0} | both_0: {both_0} | leftHang_0: {leftHang_0} | rightHang_0: {rightHang_0} | right_1: {right_1} | left_1: {left_1} | both_1: {both_1} | leftHang_1: {leftHang_1} | rightHang_1: {rightHang_1} | right_2: {right_2} | left_2: {left_2} | both_2: {both_2} | leftHang_2: {leftHang_2} | rightHang_2: {rightHang_2} | right_3: {right_3} | left_3: {left_3} | both_3: {both_3} | leftHang_3: {leftHang_3} | rightHang_3: {rightHang_3} | leftBoth_0: {leftBoth_0} | leftBoth_1: {leftBoth_1} | leftBoth_2: {leftBoth_2} | leftBoth_3: {leftBoth_3}";
	}
}
