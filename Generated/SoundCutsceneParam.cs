...
namespace EldenRingDataExtractor
{
	...
	public class SoundCutsceneParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | disableParam_NT: {disableParam_NT} | ReverbType: {ReverbType} | BgmBehaviorTypeOnStart: {BgmBehaviorTypeOnStart} | OneShotBgmBehaviorOnStart: {OneShotBgmBehaviorOnStart} | PostPlaySeId: {PostPlaySeId} | PostPlaySeIdForSkip: {PostPlaySeIdForSkip} | EnterMapMuteStopTimeOnDrawCutscene: {EnterMapMuteStopTimeOnDrawCutscene}";
	}
}
