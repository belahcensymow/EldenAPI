...
namespace EldenRingDataExtractor
{
	...
	public class AiSoundParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | radius: {radius} | lifeFrame: {lifeFrame} | forgetTime: {forgetTime} | priority: {priority} | soundBehaviorId: {soundBehaviorId} | aiSoundLevel: {aiSoundLevel}";
	}
}
