...
namespace EldenRingDataExtractor
{
	...
	public class GrassTypeParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | lodRange: {lodRange} | lod0ClusterType: {lod0ClusterType} | lod1ClusterType: {lod1ClusterType} | lod2ClusterType: {lod2ClusterType} | distributionType: {distributionType} | baseDensity: {baseDensity} | model0Name: {model0Name} | flatTextureName: {flatTextureName} | billboardTextureName: {billboardTextureName} | normalInfluence: {normalInfluence} | inclinationMax: {inclinationMax} | inclinationJitter: {inclinationJitter} | scaleBaseMin: {scaleBaseMin} | scaleBaseMax: {scaleBaseMax} | scaleHeightMin: {scaleHeightMin} | scaleHeightMax: {scaleHeightMax} | colorShade1_r: {colorShade1_r} | colorShade1_g: {colorShade1_g} | colorShade1_b: {colorShade1_b} | colorShade2_r: {colorShade2_r} | colorShade2_g: {colorShade2_g} | colorShade2_b: {colorShade2_b} | flatSplitType: {flatSplitType} | flatBladeCount: {flatBladeCount} | flatSlant: {flatSlant} | flatRadius: {flatRadius} | castShadow: {castShadow} | windAmplitude: {windAmplitude} | windCycle: {windCycle} | orientationAngle: {orientationAngle} | orientationRange: {orientationRange} | spacing: {spacing} | dithering: {dithering} | simpleModelName: {simpleModelName} | model1Name: {model1Name}";
	}
}
