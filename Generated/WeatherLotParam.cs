...
namespace EldenRingDataExtractor
{
	...
	public class WeatherLotParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | disableParam_NT: {disableParam_NT} | weatherType0: {weatherType0} | weatherType1: {weatherType1} | weatherType2: {weatherType2} | weatherType3: {weatherType3} | weatherType4: {weatherType4} | weatherType5: {weatherType5} | weatherType6: {weatherType6} | weatherType7: {weatherType7} | weatherType8: {weatherType8} | weatherType9: {weatherType9} | weatherType10: {weatherType10} | weatherType11: {weatherType11} | weatherType12: {weatherType12} | weatherType13: {weatherType13} | weatherType14: {weatherType14} | weatherType15: {weatherType15} | lotteryWeight0: {lotteryWeight0} | lotteryWeight1: {lotteryWeight1} | lotteryWeight2: {lotteryWeight2} | lotteryWeight3: {lotteryWeight3} | lotteryWeight4: {lotteryWeight4} | lotteryWeight5: {lotteryWeight5} | lotteryWeight6: {lotteryWeight6} | lotteryWeight7: {lotteryWeight7} | lotteryWeight8: {lotteryWeight8} | lotteryWeight9: {lotteryWeight9} | lotteryWeight10: {lotteryWeight10} | lotteryWeight11: {lotteryWeight11} | lotteryWeight12: {lotteryWeight12} | lotteryWeight13: {lotteryWeight13} | lotteryWeight14: {lotteryWeight14} | lotteryWeight15: {lotteryWeight15} | timezoneLimit: {timezoneLimit} | timezoneStartHour: {timezoneStartHour} | timezoneStartMinute: {timezoneStartMinute} | timezoneEndHour: {timezoneEndHour} | timezoneEndMinute: {timezoneEndMinute}";
	}
}
