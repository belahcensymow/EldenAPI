...
namespace EldenRingDataExtractor
{
	...
	public class CharmakemenutopParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | captionId: {captionId} | tableId: {tableId} | tableId2: {tableId2} | refTextId: {refTextId} | helpTextId: {helpTextId} | unlockEventFlagId: {unlockEventFlagId}";
	}
}
