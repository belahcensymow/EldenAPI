...
{
	public class RollingObjLotParam
	{
		private readonly PARAM _param;
		public RollingObjLotParam(PARAM param) => _param = param;
		public IEnumerable<RollingObjLotParamRow> Entries => _param.Rows.Select(r => new RollingObjLotParamRow(r));
	}
	public class RollingObjLotParamRow
	{
