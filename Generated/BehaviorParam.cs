...
namespace EldenRingDataExtractor
{
	...
	public class BehaviorParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | variationId: {variationId} | behaviorJudgeId: {behaviorJudgeId} | ezStateBehaviorType_old: {ezStateBehaviorType_old} | refId: {refId} | consumeSA: {consumeSA} | stamina: {stamina} | consumeDurability: {consumeDurability} | heroPoint: {heroPoint}";
	}
}
