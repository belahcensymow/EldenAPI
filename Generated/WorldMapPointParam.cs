...
namespace EldenRingDataExtractor
{
	...
	public class WorldMapPointParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | eventFlagId: {eventFlagId} | distViewEventFlagId: {distViewEventFlagId} | iconId: {iconId} | areaNo_forDistViewMark: {areaNo_forDistViewMark} | gridXNo_forDistViewMark: {gridXNo_forDistViewMark} | gridZNo_forDistViewMark: {gridZNo_forDistViewMark} | clearedEventFlagId: {clearedEventFlagId} | distViewIconId: {distViewIconId} | angle: {angle} | areaNo: {areaNo} | gridXNo: {gridXNo} | gridZNo: {gridZNo} | posX: {posX} | posY: {posY} | posZ: {posZ} | textId1: {textId1} | textEnableFlagId1: {textEnableFlagId1} | textDisableFlagId1: {textDisableFlagId1} | textId2: {textId2} | textEnableFlagId2: {textEnableFlagId2} | textDisableFlagId2: {textDisableFlagId2} | textId3: {textId3} | textEnableFlagId3: {textEnableFlagId3} | textDisableFlagId3: {textDisableFlagId3} | textId4: {textId4} | textEnableFlagId4: {textEnableFlagId4} | textDisableFlagId4: {textDisableFlagId4} | textId5: {textId5} | textEnableFlagId5: {textEnableFlagId5} | textDisableFlagId5: {textDisableFlagId5} | textId6: {textId6} | textEnableFlagId6: {textEnableFlagId6} | textDisableFlagId6: {textDisableFlagId6} | textId7: {textId7} | textEnableFlagId7: {textEnableFlagId7} | textDisableFlagId7: {textDisableFlagId7} | textId8: {textId8} | textEnableFlagId8: {textEnableFlagId8} | textDisableFlagId8: {textDisableFlagId8} | distViewId: {distViewId} | posX_forDistViewMark: {posX_forDistViewMark} | posY_forDistViewMark: {posY_forDistViewMark} | posZ_forDistViewMark: {posZ_forDistViewMark} | distViewId1: {distViewId1} | distViewId2: {distViewId2} | distViewId3: {distViewId3} | dispMinZoomStep: {dispMinZoomStep} | selectMinZoomStep: {selectMinZoomStep} | unkC0: {unkC0} | unkC4: {unkC4} | unkC8: {unkC8} | unkCC: {unkCC} | unkD0: {unkD0} | unkD4: {unkD4} | unkD8: {unkD8} | unkDC: {unkDC} | unkE0: {unkE0} | unkE4: {unkE4} | unkE8: {unkE8} | unkEC: {unkEC} | unkF0: {unkF0} | unkF4: {unkF4} | unkF8: {unkF8} | unkFC: {unkFC}";
	}
}
