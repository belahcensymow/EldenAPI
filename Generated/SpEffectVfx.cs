...
namespace EldenRingDataExtractor
{
	...
	public class SpEffectVfxRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | midstSfxId: {midstSfxId} | midstSeId: {midstSeId} | initSfxId: {initSfxId} | initSeId: {initSeId} | finishSfxId: {finishSfxId} | finishSeId: {finishSeId} | camouflageBeginDist: {camouflageBeginDist} | camouflageEndDist: {camouflageEndDist} | transformProtectorId: {transformProtectorId} | midstDmyId: {midstDmyId} | initDmyId: {initDmyId} | finishDmyId: {finishDmyId} | effectType: {effectType} | soulParamIdForWepEnchant: {soulParamIdForWepEnchant} | playCategory: {playCategory} | playPriority: {playPriority} | existEffectForLarge: {existEffectForLarge} | existEffectForSoul: {existEffectForSoul} | effectInvisibleAtCamouflage: {effectInvisibleAtCamouflage} | useCamouflage: {useCamouflage} | invisibleAtFriendCamouflage: {invisibleAtFriendCamouflage} | isHideFootEffect_forCamouflage: {isHideFootEffect_forCamouflage} | halfCamouflage: {halfCamouflage} | isFullBodyTransformProtectorId: {isFullBodyTransformProtectorId} | isInvisibleWeapon: {isInvisibleWeapon} | isSilence: {isSilence} | isMidstFullbody: {isMidstFullbody} | isInitFullbody: {isInitFullbody} | isFinishFullbody: {isFinishFullbody} | isVisibleDeadChr: {isVisibleDeadChr} | isUseOffsetEnchantSfxSize: {isUseOffsetEnchantSfxSize} | decalId1: {decalId1} | decalId2: {decalId2} | footEffectPriority: {footEffectPriority} | footEffectOffset: {footEffectOffset} | traceSfxIdOffsetType: {traceSfxIdOffsetType} | forceDeceasedType: {forceDeceasedType} | enchantStartDmyId_0: {enchantStartDmyId_0} | enchantEndDmyId_0: {enchantEndDmyId_0} | enchantStartDmyId_1: {enchantStartDmyId_1} | enchantEndDmyId_1: {enchantEndDmyId_1} | enchantStartDmyId_2: {enchantStartDmyId_2} | enchantEndDmyId_2: {enchantEndDmyId_2} | enchantStartDmyId_3: {enchantStartDmyId_3} | enchantEndDmyId_3: {enchantEndDmyId_3} | enchantStartDmyId_4: {enchantStartDmyId_4} | enchantEndDmyId_4: {enchantEndDmyId_4} | enchantStartDmyId_5: {enchantStartDmyId_5} | enchantEndDmyId_5: {enchantEndDmyId_5} | enchantStartDmyId_6: {enchantStartDmyId_6} | enchantEndDmyId_6: {enchantEndDmyId_6} | enchantStartDmyId_7: {enchantStartDmyId_7} | enchantEndDmyId_7: {enchantEndDmyId_7} | SfxIdOffsetType: {SfxIdOffsetType} | phantomParamOverwriteType: {phantomParamOverwriteType} | camouflageMinAlpha: {camouflageMinAlpha} | wetAspectType: {wetAspectType} | phantomParamOverwriteId: {phantomParamOverwriteId} | materialParamId: {materialParamId} | materialParamInitValue: {materialParamInitValue} | materialParamTargetValue: {materialParamTargetValue} | materialParamFadeTime: {materialParamFadeTime} | footDecalMaterialOffsetOverwriteId: {footDecalMaterialOffsetOverwriteId}";
	}
}
