...
namespace EldenRingDataExtractor
{
	...
	public class ActionbuttonParamRow
	{
		...
		public override string ToString() => $"ID: {ID} | Name: {Name} | dummyPoly1: {dummyPoly1} | dummyPoly2: {dummyPoly2} | radius: {radius} | angle: {angle} | depth: {depth} | width: {width} | height: {height} | baseHeightOffset: {baseHeightOffset} | allowAngle: {allowAngle} | spotDummyPoly: {spotDummyPoly} | textId: {textId} | invalidFlag: {invalidFlag} | grayoutFlag: {grayoutFlag} | overrideActionButtonIdForRide: {overrideActionButtonIdForRide} | execInvalidTime: {execInvalidTime}";
	}
}
